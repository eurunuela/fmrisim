...
def _get_parser():
    ...
    parser = argparse.ArgumentParser(
        description=("Python package to simulate fMRI data.")
    )
    ...
    optoptions.add_argument(
        ...
        dest="out_file",
        default="simulation",
        help=("Name of the output file (default='simulation')."),
        type=str,
        nargs=1,
    )
    optoptions.add_argument(
    ...
    optoptions.add_argument(
        ...
        dest="tr",
        default=2,
        help=("TR in seconds (default=2). Accepts floats."),
        type=float,
        nargs=1,
    )
    optoptions.add_argument(
        ...
        dest="te",
        default=None,
        help=("List with TE values (in ms) to simulate data with (default=None)."),
        type=float,
        nargs="+",
    )
    optoptions.add_argument(
        ...
        dest="nevents",
        default=2,
        help=("Number of neuronal events to simulate (default=2)."),
        type=int,
        nargs=1,
    )
    optoptions.add_argument(
        ...
        dest="gap",
        default=10,
        help=("Number of minimum TRs between events (default=10)."),
        type=int,
        nargs=1,
    )
    optoptions.add_argument(
        ...
        dest="maxlength",
        default=None,
        help=("Maximum number of TRs for event length (default=None)."),
        type=int,
        nargs=1,
    )
    optoptions.add_argument(
        ...
        dest="minlength",
        default=None,
        help=("Minimum number of TRs for event length (default=None)."),
        type=int,
        nargs=1,
    )
    optoptions.add_argument(
    ...
    optoptions.add_argument(
        "-hrfmodel",
        dest="hrfmodel",
        help=("HRF model to use in AFNI's 3dDeconvolve (default='SMPG1')."),
        default="SPMG1",
        type=str,
        nargs=1,
    )
    ...
    optoptions.add_argument(
        ...
        "-tesla",
        dest="tesla",
        help=("Amount of Teslas to simulate (1.5, 3 or 7). Default is 3."),
        default=3,
        type=float,
        nargs=1,
    )
    ...
    optoptions.add_argument(
        "-snr",
        dest="snr",
        help=("Amount of db to simulate (default=10.0)."),
        default=10,
        type=float,
        nargs=1,
    )
    optoptions.add_argument(
        "-motpath",
        dest="motpath",
        help=("Path to the motion parameter txt file (default=None)."),
        default=None,
        type=str,
        nargs=1,
    )
